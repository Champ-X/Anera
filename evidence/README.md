...
| [`quality-benchmark-summary.json`](./quality-benchmark-summary.json) | 18/18 Anera tasks, 99.44 average quality, and the visual-reconstruction outcome | A paired Arena benchmark |
| [`ui-state-coverage-summary.json`](./ui-state-coverage-summary.json) | 62/62 deterministic desktop states, including active HTML Writing, and interaction gates | Cross-product pixel parity or mobile coverage |
